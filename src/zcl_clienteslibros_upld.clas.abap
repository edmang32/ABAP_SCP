CLASS zcl_clienteslibros_upld DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_clienteslibros_upld IMPLEMENTATION.
...
* Load the data to the table via dynamic internal table
  ...
  METHOD get_html.
    ...
    |<!DOCTYPE HTML> \n| &&
     ...
     |    <title>ABAP File Uploader EFMG</title> \n| &&
     ...
     |                shell.setTitle("ABAP File Uploader EFMG") \n| &&
